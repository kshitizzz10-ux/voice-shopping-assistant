        ...
        <div className="p-4 sm:p-6 border-b border-slate-100 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-slate-900">Voice-Activated Catalog Search</h2>
            </div>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder='Search Indian groceries (e.g. "Amul", "Atta", "Bread", "Fish")...'
              className="w-full pl-11 pr-24 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all font-medium"
              autoFocus
            />
            {searchState.query && (
              <button
            ...
            <button
              ...
              className="absolute right-2 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold flex items-center gap-1 shadow-xs transition-all active:scale-95"
              title="Voice Search"
            >
          ...
          {results.length === 0 ? (
            ...
            results.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="flex items-center justify-between p-3.5 bg-white rounded-2xl border border-slate-200 hover:border-emerald-400 hover:shadow-xs transition-all"
                >
