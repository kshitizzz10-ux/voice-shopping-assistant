...
export const SAMPLE_VOICE_COMMANDS = [
  { category: 'Add Items', command: 'Add 2 packets of Amul milk' },
  { category: 'Add Items', command: 'I need 1 kg fresh Shimla apples' },
  { category: 'Add Items', command: 'Buy 1 dozen bananas and 1 loaf of bread' },
  { category: 'Add Items (Hindi)', command: 'दो पैकेट अमूल दूध जोड़ो' },
  ...
  { category: 'Modify Quantities', command: 'Update apples to 2 kg' },
  { category: 'Voice Search', command: 'Find toothpaste under 60 rupees' },
  { category: 'Voice Search', command: 'Search for Fortune mustard oil' },
  { category: 'Clear / Actions', command: 'Clear checked items' },
  { category: 'Clear / Actions', command: 'Clear my whole list' },
];

export const STORAGE_KEYS = {
  SHOPPING_LIST: 'voicecart_items_v2',
  PURCHASE_HISTORY: 'voicecart_history_v2',
  USER_SETTINGS: 'voicecart_settings_v2',
};
